 <aside class="main-sidebar">
    ...
    <li class="header"><b>Purchase Section</b></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>debtors/debtors/view"><i class="fa fa-circle-o"></i> View Debtors</a></li>
    ...
    <li class="header"><b>Report Section</b></li>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../tables/simple.html"><i class="fa fa-circle-o"></i> View Reports</a></li>
            <li><a href="../tables/data.html"><i class="fa fa-circle-o"></i> View Ledgers</a></li>
          </ul>
        </li>
